...
public class ControllerExceptionHandlerUtility {
  ...
  public final ResponseEntity<Object> handleGeneralException(Exception ex, WebRequest request) {
    ...
    ErrorMessageUtility errorMessage = new ErrorMessageUtility(ex.getLocalizedMessage(),
  ...
  public final ResponseEntity<Object> handleCarException(CarNotFoundException ex,
      WebRequest request) {
    Instant timeStamp = Instant.now();
    ErrorMessageUtility errorMessage = new ErrorMessageUtility(ex.getMessage(),
